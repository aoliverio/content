...
<script>
    $(document).ready(function () {
         ...
         * Related news
         */
        $(".related-news-edit-button").click(function () {
            var id = $(this).attr("content_id");
            var URL = '<?= $this->Url->build('/content/CmsContent/editRelatedNews/', true); ?>' + id;
            $("#related-news-edit").load(URL);
        });
...
<!-- News title -->
<h1 class="news-header"><?= __('Edit News'); ?></h1>
...
<div>
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane" id="tab3">
            <div class="row">
                <div class="col-md-9">
                    <h4 class="news-header"><?= __('Content Taxonomy'); ?></h4>
                    <div class="well well-sm">
        ...
        <div role="tabpanel" class="tab-pane" id="tab4">
            <div class="row">
                <div class="col-md-9">
                    <h4 class="news-header"><?= __('List of Attachments'); ?></h4>
                    ...
                    <?php } ?>
                    <h4 class="news-header"><?= __('Add Attachments'); ?></h4>
        ...
        <div role="tabpanel" class="tab-pane" id="tab5">
            <div class="row">
                <div class="col-md-9">
                    <h4 class="news-header"><?= __('List of Images'); ?></h4>
                    ...
                    <?php } else { ?>
                        <p class="text-center"><?= __('Empty') ?></p>
                    <?php } ?> 
                    <h4 class="news-header"><?= __('Add Images'); ?></h4>
        ...
        <div role="tabpanel" class="tab-pane" id="tab6">
            <div class="row">
                <div class="col-md-9">
                    <h4 class="news-header"><?= __('List of Meta Key'); ?></h4>
                    ...
                    <?php } else { ?>
                        <p class="text-center"><?= __('Empty') ?></p>
                    <?php } ?>
                    <h4 class="news-header"><?= __('Add Meta Key'); ?></h4>
        ...
        <div role="tabpanel" class="tab-pane" id="tab7">
            <div class="row">
                <div class="col-md-9">
                    <h4 class="news-header"><?= __('Content Permits'); ?></h4>
                    <div class="well well-sm">   
                        <ul class="nav nav-tabs" role="tablist">

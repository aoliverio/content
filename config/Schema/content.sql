...
CREATE TABLE IF NOT EXISTS `cms_term_taxonomies` (
  ...
  `cms_taxonomy_id` INT(11) NOT NULL,
  `title` VARCHAR(255) NULL DEFAULT NULL,
  `description` TEXT NULL DEFAULT NULL,
  ...
  INDEX `cms_taxonomies_key1_idx` (`cms_taxonomy_id` ASC),
  CONSTRAINT `fk_cms_term_taxonomies_cms_terms`
    FOREIGN KEY (`cms_term_id`)
    REFERENCES `cms_terms` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_cms_term_taxonomies_cms_taxonomies`
    FOREIGN KEY (`cms_taxonomy_id`)
    REFERENCES `cms_taxonomies` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- -----------------------------------------------------
-- Table `csm_term_users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `csm_term_users` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `cms_term_id` INT(11) NOT NULL,
  `user_id` INT(11) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_csm_term_users_cms_terms1_idx` (`cms_term_id` ASC),
  INDEX `fk_csm_term_users_users1_idx` (`user_id` ASC),
  CONSTRAINT `fk_csm_term_users_cms_terms1`
    FOREIGN KEY (`cms_term_id`)
    REFERENCES `cms_terms` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_csm_term_users_users1`
    FOREIGN KEY (`user_id`)
    REFERENCES `users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)

...
use Content\Model\Table\CmsSiteUsersTable;

/**
 * Content\Model\Table\CmsSiteUsersTable Test Case
 */
class CmsSiteUsersTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \Content\Model\Table\CmsSiteUsersTable
     */
    public $CmsSiteUsers;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('CmsSiteUsers') ? [] : ['className' => 'Content\Model\Table\CmsSiteUsersTable'];
        $this->CmsSiteUsers = TableRegistry::get('CmsSiteUsers', $config);
    }

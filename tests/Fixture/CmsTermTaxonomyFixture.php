...
/**
 * CmsTermTaxonomyFixture
 *
 */
class CmsTermTaxonomyFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'cms_term_taxonomy';
    ...
    public $fields = [
        ...
        'parent_id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'cms_term_id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'taxonomy' => ['type' => 'string', 'length' => 32, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'taxonomy' => ['type' => 'index', 'columns' => ['taxonomy'], 'length' => []],
            'fk_cms_term_taxonomy_cms_term1_idx' => ['type' => 'index', 'columns' => ['cms_term_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_cms_term_taxonomy_cms_term1' => ['type' => 'foreign', 'columns' => ['cms_term_id'], 'references' => ['cms_term', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'count' => '',
            'created' => '2015-09-28 11:16:08',
            'created_user' => 1,
            'modified' => '2015-09-28 11:16:08',
            'modified_user' => 1
        ],
    ];
}

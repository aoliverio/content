...
class CmsTermTaxonomiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cms_term_taxonomy_type_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            ...
            'fk_cms_term_taxonomies_cms_term_taxonomy_types1_idx' => ['type' => 'index', 'columns' => ['cms_term_taxonomy_type_id'], 'length' => []],
        ],
        '_constraints' => [
            ...
            'fk_cms_term_taxonomies_cms_term_taxonomy_types1' => ['type' => 'foreign', 'columns' => ['cms_term_taxonomy_type_id'], 'references' => ['cms_term_taxonomy_types', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
